...
/**
 * @CLASSNAME QuartzDefault
 * @Description  springboot 默认的定时调度配置（不需要任何包）但是不能动态的开启（关闭）或者添加 任务
 * @Auther Jan  橙寂
 * @DATE 2019/9/2 0002 14:46
 */
@Configuration
//@EnableScheduling //开启定时调度的开关
public class QuartzDefault {
